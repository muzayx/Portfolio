...
const projects = [
    {
        id: 1,
        name: 'Portfólio',
        description: 'Meu portfólio, desenvolvido com linguagens básicas e em constante evolução.',
        image: 'site.png',
    ...
    },
    {
        ...
        description: 'Verificador de senha simples que indica os caracteres já presentes e o que ainda falta para uma senha forte.',
        image: 'senha.png',
        technologies: ['HTML', 'Tailwind CSS', 'JavaScript'],
    ...
    },
    {
        id: 3,
        name: 'Jogo da Forca',
        description: 'Desenvolvido por mim em C#, este jogo oferece interfaces para digitar, escolher letras e muito mais.',
        image: 'forca.png',
        technologies: ['C#'],
        link: 'https://github.com/muzayx/Forca'
    },
    {
        id: 4,
        name: 'Poke API',
        description: 'Uma API que desenvolvi em colaboração com outros membros do meu grupo, permitindo a busca de Pokémon e o retorno de suas informações detalhadas.',
        image: 'poke.png',
